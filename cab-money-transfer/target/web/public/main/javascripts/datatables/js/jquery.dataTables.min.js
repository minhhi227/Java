...
b])}function oa(a){var b=j.defaults.oLanguage;!a.sEmptyTable&&a.sZeroRecords&&"Pas de données disponibles dans le tableau"===b.sEmptyTable&&p(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&a.sZeroRecords&&"Chargement..."===b.sLoadingRecords&&p(a,a,"sZeroRecords","sLoadingRecords")}function ya(a){if(a.oScroll.bInfinite)return null;var b='<select size="1" '+('name="'+a.sTableId+'_length"')+">",c,d,f=a.aLengthMenu;if(2==f.length&&"object"===typeof f[0]&&"object"===typeof f[1])for(c=0,d=f[0].length;c<d;c++)b+='<option value="'+
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"Pas de données disponibles dans le tableau",sInfo:"Affichage _END_ de _TOTAL_ entrées",sInfoEmpty:"Affichage 0 de 0 entrées",sInfoFiltered:"(filtré _MAX_ total des entrées)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Chargement...",sProcessing:"Processing...",sSearch:"Search:",sUrl:"",sZeroRecords:"Aucun enregistrement correspondant n'a été trouvé"},
